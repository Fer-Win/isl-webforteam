...
const PlayerCard: React.FC<PlayerCardProps> = ({  image, name, stats }) => {
  return (
    <a href={`/player/${name}`} className='group hover:rounded-md'>
       <div className='  overflow-hidden w-[270px] hover:rounded-md transition-all ease-out duration-500 group '>
     ...
     <div className='flex flex-col px-3 py-2 bg-[#013ca6] border-2 border-white font-familjen group-hover:rounded-b-md transition-all ease-in duration-500'>
